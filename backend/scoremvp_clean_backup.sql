...
DROP DATABASE IF EXISTS scoremvp;
--
-- Name: scoremvp; Type: DATABASE; Schema: -; Owner: admin
--

CREATE DATABASE scoremvp WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C.UTF-8';


ALTER DATABASE scoremvp OWNER TO admin;
