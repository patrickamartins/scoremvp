...
export function AdminLayout({ children, user = { name: 'Admin', avatarUrl: '' } }: AdminLayoutProps) {
  ...
  return (
    <div className="flex min-h-screen bg-[#E3E3E3]" style={{ fontFamily: 'Jakarta Sans, sans-serif' }}>
      {/* Sidebar Fixo */}
      ...
      <div className="flex-1 flex flex-col min-h-screen ml-64">
        ...
        <main className="flex-1 p-8 bg-[#F7F8FA] min-h-[calc(100vh-4rem)] pt-16">
          {children}
        </main>
      </div>
    </div>
